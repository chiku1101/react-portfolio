  ...
  useEffect(() => {
    ...
    const fetchSpotifyData = async () => {
      try {
        ...
        // For local development: 'http://localhost:3000/api/spotify'
        // For production: 'https://your-domain.com/api/spotify'
        const apiUrl = import.meta.env.VITE_SPOTIFY_API_URL || '/api/spotify';
                ...
                <div className="bg-white rounded-lg p-4 border border-gray-200 shadow-sm">
                  {spotifyLoading ? (
                    <div className="flex items-center justify-center py-4">
                      <div className="text-xs text-gray-400 tracking-airy">Loading...</div>
                    </div>
                  ) : spotifyData?.track ? (
                    <a
                    ...
                    >
                      <div className="flex-1">
                        <p className="text-xs text-gray-400 mb-1 tracking-airy">
                        ...
                        <p className="text-xs text-gray-400">
                          {spotifyData.track.timeAgo || 'Recently'}
                        </p>
                      </div>
                      <div className="w-10 h-10 bg-[#1DB954] rounded-full flex items-center justify-center flex-shrink-0 ml-3">
